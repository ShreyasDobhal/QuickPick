...
import components.TransactionPanel;
...
public class TransactionPage extends javax.swing.JFrame {
    ...
    public TransactionPage() {
        ...
        Thread background = new Thread(()->{
            ...
            System.out.println("Background thread of transaction page ended");
        });
        //background.start();
        
//        Thread addTrans=new Thread(()->{
//            for (int i=0;i<1;i++)
//            {
...
//        addTrans.start();
    ...
    private void initComponents() {
        ...
        transactionPanel2 = new components.TransactionPanel();
        scroll = new javax.swing.JScrollPane();
        panel = new javax.swing.JPanel();
        transactionPanel3 = new components.TransactionPanel();
        transactionPanel1 = new components.TransactionPanel();
        ...
        getContentPane().add(transactionPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 640, -1, -1));

        scroll.setHorizontalScrollBar(null);

        panel.setLayout(new java.awt.GridLayout(0, 1));
        panel.add(transactionPanel3);
        panel.add(transactionPanel1);

        scroll.setViewportView(panel);

        getContentPane().add(scroll, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 140, 1200, 460));
    ...
    private components.TransactionPanel transactionPanel1;
    private components.TransactionPanel transactionPanel2;
    private components.TransactionPanel transactionPanel3;
